...
// Service is the linkedin service interface.
...
// RegisterURLPayload is the payload type of the linkedin service register-url
// method.
type RegisterURLPayload struct {
	APIKey *string
}

// AttachToAccountPayload is the payload type of the linkedin service
...
// DetachFromAccountPayload is the payload type of the linkedin service
...
// ReceivePayload is the payload type of the linkedin service receive method.
...
// UserMedia is the result type of the linkedin service receive method.
...
// UserMedia.
func NewUserMedia(vres *linkedinviews.UserMedia) *UserMedia {
	var res *UserMedia
	switch vres.View {
	case "default", "":
...
func NewViewedUserMedia(res *UserMedia, view string) *linkedinviews.UserMedia {
	var vres *linkedinviews.UserMedia
	switch view {
	case "default", "":
		p := newUserMediaView(res)
		vres = &linkedinviews.UserMedia{p, "default"}
	}
	return vres
}

// newUserMedia converts projected type UserMedia to service type UserMedia.
func newUserMedia(vres *linkedinviews.UserMediaView) *UserMedia {
	res := &UserMedia{
...
func newUserMediaView(res *UserMedia) *linkedinviews.UserMediaView {
	vres := &linkedinviews.UserMediaView{
		ID:               &res.ID,
