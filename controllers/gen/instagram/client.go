...
// RegisterURL calls the "register-url" endpoint of the "instagram" service.
...
// AttachToAccount calls the "attach-to-account" endpoint of the "instagram"
// service.
...
// DetachFromAccount calls the "detach-from-account" endpoint of the
// "instagram" service.
...
// Receive calls the "receive" endpoint of the "instagram" service.
