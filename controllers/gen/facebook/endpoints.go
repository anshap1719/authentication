...
// Use applies the given middleware to all the "facebook" service endpoints.
...
// "register-url" of service "facebook".
...
// method "attach-to-account" of service "facebook".
...
// method "detach-from-account" of service "facebook".
