...
// RegisterURLPayload is the payload type of the facebook service register-url
// method.
type RegisterURLPayload struct {
	APIKey *string
}

// AttachToAccountPayload is the payload type of the facebook service
...
// DetachFromAccountPayload is the payload type of the facebook service
...
func NewViewedUserMedia(res *UserMedia, view string) *facebookviews.UserMedia {
	var vres *facebookviews.UserMedia
	switch view {
	case "default", "":
		p := newUserMediaView(res)
		vres = &facebookviews.UserMedia{p, "default"}
	}
	return vres
}

// newUserMedia converts projected type UserMedia to service type UserMedia.
func newUserMedia(vres *facebookviews.UserMediaView) *UserMedia {
	res := &UserMedia{
...
func newUserMediaView(res *UserMedia) *facebookviews.UserMediaView {
	vres := &facebookviews.UserMediaView{
		ID:               &res.ID,
