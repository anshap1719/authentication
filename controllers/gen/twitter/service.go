...
// RegisterURLPayload is the payload type of the twitter service register-url
// method.
type RegisterURLPayload struct {
	APIKey *string
}

// AttachToAccountPayload is the payload type of the twitter service
...
// DetachFromAccountPayload is the payload type of the twitter service
...
func NewViewedUserMedia(res *UserMedia, view string) *twitterviews.UserMedia {
	var vres *twitterviews.UserMedia
	switch view {
	case "default", "":
		p := newUserMediaView(res)
		vres = &twitterviews.UserMedia{p, "default"}
	}
	return vres
}

// newUserMedia converts projected type UserMedia to service type UserMedia.
func newUserMedia(vres *twitterviews.UserMediaView) *UserMedia {
	res := &UserMedia{
...
func newUserMediaView(res *UserMedia) *twitterviews.UserMediaView {
	vres := &twitterviews.UserMediaView{
		ID:               &res.ID,
