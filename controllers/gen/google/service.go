...
// Service is the google service interface.
...
// RegisterURLPayload is the payload type of the google service register-url
// method.
...
// AttachToAccountPayload is the payload type of the google service
...
// DetachFromAccountPayload is the payload type of the google service
...
// ReceivePayload is the payload type of the google service receive method.
...
// UserMedia is the result type of the google service receive method.
...
// UserMedia.
func NewUserMedia(vres *googleviews.UserMedia) *UserMedia {
	var res *UserMedia
	switch vres.View {
	case "default", "":
...
func NewViewedUserMedia(res *UserMedia, view string) *googleviews.UserMedia {
	var vres *googleviews.UserMedia
	switch view {
	case "default", "":
		p := newUserMediaView(res)
		vres = &googleviews.UserMedia{p, "default"}
	}
	return vres
}

// newUserMedia converts projected type UserMedia to service type UserMedia.
func newUserMedia(vres *googleviews.UserMediaView) *UserMedia {
	res := &UserMedia{
...
func newUserMediaView(res *UserMedia) *googleviews.UserMediaView {
	vres := &googleviews.UserMediaView{
		ID:               &res.ID,
