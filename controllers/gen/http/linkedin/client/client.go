...
//
// linkedin client HTTP transport
//
// Command:
...
// RegisterURL returns an endpoint that makes HTTP requests to the linkedin
...
func (c *Client) RegisterURL() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("linkedin", "register-url", err)
		}
		return decodeResponse(resp)
	}
}

// AttachToAccount returns an endpoint that makes HTTP requests to the linkedin
...
func (c *Client) AttachToAccount() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("linkedin", "attach-to-account", err)
		}
		return decodeResponse(resp)
	}
}
...
// linkedin service detach-from-account server.
func (c *Client) DetachFromAccount() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("linkedin", "detach-from-account", err)
		}
		return decodeResponse(resp)
	}
}

// Receive returns an endpoint that makes HTTP requests to the linkedin service
// receive server.
func (c *Client) Receive() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("linkedin", "receive", err)
		}
		return decodeResponse(resp)
	}
}
