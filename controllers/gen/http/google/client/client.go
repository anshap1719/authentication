...
// RegisterURL returns an endpoint that makes HTTP requests to the google
...
func (c *Client) RegisterURL() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("google", "register-url", err)
		}
		return decodeResponse(resp)
	}
}

// AttachToAccount returns an endpoint that makes HTTP requests to the google
...
func (c *Client) AttachToAccount() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("google", "attach-to-account", err)
		}
		return decodeResponse(resp)
	}
}

// DetachFromAccount returns an endpoint that makes HTTP requests to the google
// service detach-from-account server.
func (c *Client) DetachFromAccount() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("google", "detach-from-account", err)
		}
		return decodeResponse(resp)
	}
}

// Receive returns an endpoint that makes HTTP requests to the google service
// receive server.
func (c *Client) Receive() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("google", "receive", err)
		}
		return decodeResponse(resp)
	}
}
