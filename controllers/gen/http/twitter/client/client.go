...
// RegisterURL returns an endpoint that makes HTTP requests to the twitter
...
func (c *Client) RegisterURL() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("twitter", "register-url", err)
		}
		return decodeResponse(resp)
	}
}

// AttachToAccount returns an endpoint that makes HTTP requests to the twitter
...
func (c *Client) AttachToAccount() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("twitter", "attach-to-account", err)
		}
		return decodeResponse(resp)
	}
}
...
// twitter service detach-from-account server.
func (c *Client) DetachFromAccount() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("twitter", "detach-from-account", err)
		}
		return decodeResponse(resp)
	}
}

// Receive returns an endpoint that makes HTTP requests to the twitter service
// receive server.
func (c *Client) Receive() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("twitter", "receive", err)
		}
		return decodeResponse(resp)
	}
}
