...
//
// facebook client HTTP transport
//
// Command:
...
// Client lists the facebook service endpoint HTTP clients.
type Client struct {
...
// NewClient instantiates HTTP clients for all the facebook service servers.
func NewClient(
	scheme string,
	host string,
	doer goahttp.Doer,
...
// RegisterURL returns an endpoint that makes HTTP requests to the facebook
...
func (c *Client) RegisterURL() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("facebook", "register-url", err)
		}
		return decodeResponse(resp)
	}
}

// AttachToAccount returns an endpoint that makes HTTP requests to the facebook
// service attach-to-account server.
func (c *Client) AttachToAccount() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("facebook", "attach-to-account", err)
		}
		return decodeResponse(resp)
	}
}
...
// facebook service detach-from-account server.
func (c *Client) DetachFromAccount() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("facebook", "detach-from-account", err)
		}
		return decodeResponse(resp)
	}
}

// Receive returns an endpoint that makes HTTP requests to the facebook service
// receive server.
func (c *Client) Receive() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("facebook", "receive", err)
		}
		return decodeResponse(resp)
	}
}
