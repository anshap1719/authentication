...
// NewReceiveUserMediaOK builds a "facebook" service "receive" endpoint result
// from a HTTP "OK" response.
func NewReceiveUserMediaOK(body *ReceiveResponseBody, authorization string, xSession string) *facebookviews.UserMediaView {
	v := &facebookviews.UserMediaView{
		ID:               body.ID,
