...
//
// monitoring client HTTP transport
//
// Command:
...
// Status returns an endpoint that makes HTTP requests to the monitoring
...
func (c *Client) Status() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("monitoring", "status", err)
		}
